...
| Bệnh nhân | Nối XML1 và XML3 bằng `MA_LK`; ưu tiên hiển thị `MA_BN` (cột 3) và `HO_TEN` (cột 4) của XML1 |
...
Phiên bản hiện tại: **1.3.0** · ngày **2026-08-28** · múi giờ **Asia/Ho_Chi_Minh (GMT+7)**. Xem [CHANGELOG.md](CHANGELOG.md) để biết lịch sử thay đổi.
